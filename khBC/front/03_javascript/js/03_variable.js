...
age1 = "안녕";  //변수 사용시 대입되는 데이터의 타입이 변경되면 변수의 자료형도 같이 변경
console.log(age1, typeof age1);
{
    var test1 = "test1";
...
console.log(test1);
//var 를 이용해서 변수를 선언하면 변수 범위가 효과가 없음. ( 코드 블록과 관계 없음 )
// -> 복잡한 코드를 작성할 때 이미 사용된 변수인지 체크가 힘듦.
...
//console.log(test2); //let 으로 선언한 변수는 중괄호 내부까지만 사용이 가능.

//3.const(상수) : 한번 값이 대입되고나면 변경이 불가능
