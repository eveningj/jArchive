/*
    javascript 의 자료형 -> 변수에 저장되는 자료의 형태
...
//문자열 -> string : 문자와 문자열을 구분하지 않음 / "문자열", '문자열 ' 둘다 표현 가능함.
const str = "JavaScript";
console.log(str, typeof str, typeof(str));

//javascript 의 string 타입에 내장되어 있는 함수
...
//매개변수로 전달한 문자열이 대상 문자열에 몇번쨰에 있는지 찾아서 그 위치를 리턴(앞에서부터)
console.log(str.indexOf("a"));
//매개변수로 전달한 문자열이 대상 문자열에 몇번쨰에 있는지 찾아서 그 위치를 리턴(뒤에서부터)
console.log(str.lastIndexOf("a"));
//매개변수로 전달한 문자열이 없으면 -1 리턴
console.log(str.indexOf("z"));
//문자열 중 해당 인덱스에 위치한 문자열 1개 추출해서 리턴
console.log(str.charAt(4));
//for (int i = 3, i <7); -> 7은 포함되지않음.
console.log(str.substring(3,7));    //문자열 3번 인덱스 부터 7번 앞까지 문자열을 리턴
...
//숫자타입 -> number -> 정수/실수 구분하지 않고 모두 nujmber
const num1 = 10;
...
console.log(Math.abs(-10));
console.log(Math.random()); //0~1사이 랜덤 실수 1개 추출
...
console.log(userAge + userGrade); // 20 + "2" -> "202"
console.log(userAge - userGrade); // 20 - "2" -> 20 -2 -> 18
console.log(userName - userAge);    //"유저1" - 20 -> 연산 불가능 => NaN(Not a Number)
...
const oper1 = 1;
const oper2 = "1";
console.log(oper1 == oper2);    //자료형과 관계없이 자동 형변환을 해서 값이 일치하면 true
...
const input =Number(prompt("정수를 입력하세요."));
